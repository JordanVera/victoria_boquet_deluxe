...
export const BOUQUET_PACKAGES: PricingPackage[] = [
  {
    id: '25',
    name: '25 Roses',
    price: '$110',
  ...
  },
  {
    ...
    description:
      'The full Bloomify statement — four colors, maximum impact, made to be carried and photographed.',
    features: [
...
export const ADD_ONS: PricingPackage[] = [
  ...
  },
  {
    ...
    features: [
      'Graduation tassel pink/black +$10',
      'Initial or number +$20',
      'Graduation pink or black wrap',
...
export const PRICING_NOTES = [
  'A 50% deposit is required to place your order after Bloomify confirms details.',
  'Pickup is in Far East El Paso. Delivery is available for an additional fee.',
  ...
  'Se habla español. Orders can also be started via Instagram DM @bloomifyboutique.',
];
